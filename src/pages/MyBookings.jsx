  ...
  return (
    <div className="min-h-screen bg-sand-50 px-6 py-24 lg:px-10">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mt-6 text-3xl font-light text-palm-900">
        ...
        <div className="mt-8 space-y-4">
          ...
          {!loading && bookings.length === 0 && (
            <div className="rounded-2xl border border-dashed border-palm-800/20 p-10 text-center text-palm-600">
              ...
              <a href="/#alojamiento" className="font-normal text-lagoon-700">
          ...
          {bookings.map((b) => (
            ...
            >
              <div>
                <p className="font-normal text-palm-900">{b.room_name}</p>
